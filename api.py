...
BOT_TOKEN = "8208876135:AAFgboLqlMxiiNcD9Ejko5QEz3l1FlTgTzk"
...
def register():
    ...
    if username in users:
        ...
        # User exists - validate they can login
...
def bot_ban(message):
    ...
    bot.reply_to(message, f"🚫 User `{username}` has been permanently banned.", parse_mode="Markdown")
